...
const initialSampleVessels = [
  {
    ...
    metaDescription: {
      en: "Commercial specifications, general arrangement plan, 2x 30MT crane capacities, grain capacity 8,391 cbm, and photo inspection gallery of 6,408 DWT geared bulk carrier MV MOLPADIA.",
  ...
  },
  {
    ...
    metaDescription: {
      en: "Commercial specifications, general arrangement plan, and photo inspection gallery of 7,639.45 DWT general cargo vessel MV METANIRA.",
      ua: "Комерційні характеристики, генеральний план вантажного судна MV METANIRA (7,639.45 DWT).",
      ru: "Коммерческие характеристики, генеральный план грузового судна MV METANIRA (7,639.45 DWT).",
    },
